...
const View = ({ items, isLoading, onDeleteItem, onEditItem, keywords, onKeywordChange }) => (
  <>
    <Box marginBottom="1em">
      <Card>
        <Grid container justify="space-between" alignItems="center">
          <Text fontSize="1.2em" fontWeight="bold">Perfiles</Text>
          <div>
            <Grid container wrap="nowrap" alignItems="center">
              ...
              <Link to="/dashboard/profiles/editor">
                <Button width="8em" color={colors.green} variant="contained">Crear Perfil</Button>
              </Link>
            </Grid>
          </div>
        </Grid>
    ...
    {(!items || !items.length) && !isLoading && (
      <Empty message={keywords ? 'No encontramos resultados' : 'Aún no tienes Perfiles'} />
    )}
    {isLoading && (
